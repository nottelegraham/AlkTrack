...
void handleSerialCommands() {
  ...
  if (line.startsWith("CAL ")) {
    ...
    Serial.println("  Step 3/4 — Tank/sump line (Pump B, 20 s)");
    runPumpBlocking(PUMP_TANK, 20000UL);
    Serial.println("  Step 4/4 — Drain line (Pump C, 20 s)");
    runPumpBlocking(PUMP_WASTE, 20000UL);
    Serial.println("PRIME complete. All lines should now be water-filled.");
